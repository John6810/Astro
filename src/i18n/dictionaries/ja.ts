// 日本語 locale — wording from the existing translations.ts `jp` block,
// renamed `jp` -> `ja` per migration spec. Content preserved verbatim.
...
const dict: Dict = {
  ...
  meta_description:
    "Senior Cloud Platform Architect、15年以上のIT経験。Azure Landing Zonesゼロから構築、Terraform/GitOps、エンタープライズガバナンス。Belgium · Luxembourg · EU Remote。",
  ...
  exp_refs_eyebrow: "準拠規格",
  exp_sources_eyebrow: "ソース・参考資料",
  job1_ref_label: "準拠規格",
